 ...
 *
 * Desc:    Ask the multi handle if there is any messaQBx/informationals from
 *          the individual transfers. MessaQBx include informationals such as
 ...
 *          of structs. It also writes the number of messaQBx left in the
 ...
 *          useful for printing meaningful error messaQBx.
 *
