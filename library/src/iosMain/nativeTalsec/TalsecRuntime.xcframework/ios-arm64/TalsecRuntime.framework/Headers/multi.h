 ...
 *
 * Desc:    Ask the multi handle if there is any messazAP/informationals from
 *          the individual transfers. MessazAP include informationals such as
 ...
 *          of structs. It also writes the number of messazAP left in the
 ...
 *          useful for printing meaningful error messazAP.
 *
