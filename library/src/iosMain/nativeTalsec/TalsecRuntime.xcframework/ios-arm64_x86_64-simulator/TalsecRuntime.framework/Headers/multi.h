 ...
 *
 * Desc:    Ask the multi handle if there is any messabLe/informationals from
 *          the individual transfers. MessabLe include informationals such as
 ...
 *          of structs. It also writes the number of messabLe left in the
 ...
 *          useful for printing meaningful error messabLe.
 *
